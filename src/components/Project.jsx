...
const Project = ({ image, name, text, link, code, tags }) => {
  return (
    <div className="w-full bg-pfBgLight p-3 flex flex-col items-center lg:items-start space-y-2 rounded-xl hover:scale-[1.03] duration-300 drop-shadow-xl col-span-1 md:last:col-[2_/span_1]">
